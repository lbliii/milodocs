...
- **Ergonomic**: The drafting UX is markdown focused with near-instant local previews; for non-technical contributors, you can plug into CMS interfaces (e.g., [Frontmatter](https://frontmatter.codes/))
